...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221107181511_Initial')
BEGIN
    CREATE TABLE [Genres] (
...
BEGIN
    ...
    VALUES (N'20221107181511_Initial', N'6.0.10');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111162820_Actors')
BEGIN
    ...
    ALTER TABLE [Genres] ALTER COLUMN [Name] nvarchar(50) NOT NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221111162820_Actors', N'6.0.10');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221112133111_MovieTheaters')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221112133111_MovieTheaters', N'6.0.10');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221122161119_MoviesAndComponents')
BEGIN
    CREATE TABLE [Movies] (
        [Id] int NOT NULL IDENTITY,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221122161119_MoviesAndComponents', N'6.0.10');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221201134502_IdentityTables')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221201134502_IdentityTables', N'6.0.10');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221203111044_RatingTable')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221203111044_RatingTable', N'6.0.10');
END;
GO
