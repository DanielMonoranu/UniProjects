...
namespace WindowsFormsApplication34 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row AddDataTable1Row(decimal EXPR1, decimal EXPR2) {
        ...
        public partial class ANGAJATIDataTable : global::System.Data.TypedTableBase<ANGAJATIRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ANGAJATIRow AddANGAJATIRow(decimal NR_CRT, string NUME, string PRENUME, string FUNCTIE, decimal SALAR_BAZA, decimal SPOR_PROCENT, decimal PREMII_BRUTE, decimal TOTAL_BRUT, decimal BRUT_IMPOZABIL, decimal CAS, decimal CASS, decimal IMPOZIT, decimal RETINERI, decimal VIRAT_CARD) {
            ...
            private void InitClass() {
                ...
                this.columnFUNCTIE.MaxLength = 10;
            }
        ...
        public partial class ANGAJATIRow : global::System.Data.DataRow {
            ...
            public decimal SPOR_PROCENT {
                get {
                    try {
                        return ((decimal)(this[this.tableANGAJATI.SPOR_PROCENTColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'SPOR_PROCENT\' in table \'ANGAJATI\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableANGAJATI.SPOR_PROCENTColumn] = value;
                }
            }
            ...
            public bool IsSPOR_PROCENTNull() {
                return this.IsNull(this.tableANGAJATI.SPOR_PROCENTColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetSPOR_PROCENTNull() {
                this[this.tableANGAJATI.SPOR_PROCENTColumn] = global::System.Convert.DBNull;
            }
...
namespace WindowsFormsApplication34.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication34.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SUM(SALAR_BAZA) AS EXPR1, SUM(VIRAT_CARD) AS EXPR2\r\nFROM     DANI.ANGAJATI" +
                "";
    ...
    public partial class ANGAJATITableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO ""DANI"".""ANGAJATI"" (""NR_CRT"", ""NUME"", ""PRENUME"", ""FUNCTIE"", ""SALAR_BAZA"", ""SPOR_PROCENT"", ""PREMII_BRUTE"", ""TOTAL_BRUT"", ""BRUT_IMPOZABIL"", ""CAS"", ""CASS"", ""IMPOZIT"", ""RETINERI"", ""VIRAT_CARD"") VALUES (:NR_CRT, :NUME, :PRENUME, :FUNCTIE, :SALAR_BAZA, :SPOR_PROCENT, :PREMII_BRUTE, :TOTAL_BRUT, :BRUT_IMPOZABIL, :CAS, :CASS, :IMPOZIT, :RETINERI, :VIRAT_CARD)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE \"DANI\".\"ANGAJATI\" SET \"NR_CRT\" = :NR_CRT, \"NUME\" = :NUME, \"PRENUME\" = :PRE" +
                "NUME, \"FUNCTIE\" = :FUNCTIE, \"SALAR_BAZA\" = :SALAR_BAZA, \"SPOR_PROCENT\" = :SPOR_P" +
                "ROCENT, \"PREMII_BRUTE\" = :PREMII_BRUTE, \"TOTAL_BRUT\" = :TOTAL_BRUT, \"BRUT_IMPOZA" +
                "BIL\" = :BRUT_IMPOZABIL, \"CAS\" = :CAS, \"CASS\" = :CASS, \"IMPOZIT\" = :IMPOZIT, \"RET" +
                "INERI\" = :RETINERI, \"VIRAT_CARD\" = :VIRAT_CARD WHERE ((\"NR_CRT\" = :Original_NR_C" +
                "RT) AND ((:IsNull_NUME = 1 AND \"NUME\" IS NULL) OR (\"NUME\" = :Original_NUME)) AND" +
                " ((:IsNull_PRENUME = 1 AND \"PRENUME\" IS NULL) OR (\"PRENUME\" = :Original_PRENUME)" +
                ") AND ((:IsNull_FUNCTIE = 1 AND \"FUNCTIE\" IS NULL) OR (\"FUNCTIE\" = :Original_FUN" +
                "CTIE)) AND ((:IsNull_SALAR_BAZA = 1 AND \"SALAR_BAZA\" IS NULL) OR (\"SALAR_BAZA\" =" +
                " :Original_SALAR_BAZA)) AND ((:IsNull_SPOR_PROCENT = 1 AND \"SPOR_PROCENT\" IS NUL" +
                "L) OR (\"SPOR_PROCENT\" = :Original_SPOR_PROCENT)) AND ((:IsNull_PREMII_BRUTE = 1 " +
                "AND \"PREMII_BRUTE\" IS NULL) OR (\"PREMII_BRUTE\" = :Original_PREMII_BRUTE)) AND ((" +
                ":IsNull_TOTAL_BRUT = 1 AND \"TOTAL_BRUT\" IS NULL) OR (\"TOTAL_BRUT\" = :Original_TO" +
                "TAL_BRUT)) AND ((:IsNull_BRUT_IMPOZABIL = 1 AND \"BRUT_IMPOZABIL\" IS NULL) OR (\"B" +
                "RUT_IMPOZABIL\" = :Original_BRUT_IMPOZABIL)) AND ((:IsNull_CAS = 1 AND \"CAS\" IS N" +
                "ULL) OR (\"CAS\" = :Original_CAS)) AND ((:IsNull_CASS = 1 AND \"CASS\" IS NULL) OR (" +
                "\"CASS\" = :Original_CASS)) AND ((:IsNull_IMPOZIT = 1 AND \"IMPOZIT\" IS NULL) OR (\"" +
                "IMPOZIT\" = :Original_IMPOZIT)) AND ((:IsNull_RETINERI = 1 AND \"RETINERI\" IS NULL" +
                ") OR (\"RETINERI\" = :Original_RETINERI)) AND ((:IsNull_VIRAT_CARD = 1 AND \"VIRAT_" +
                "CARD\" IS NULL) OR (\"VIRAT_CARD\" = :Original_VIRAT_CARD)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::Oracle.ManagedDataAccess.Client.OracleCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT DANI.ANGAJATI.*\r\nFROM     DANI.ANGAJATI";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(decimal Original_NR_CRT, string Original_NUME, string Original_PRENUME, string Original_FUNCTIE, global::System.Nullable<decimal> Original_SALAR_BAZA, global::System.Nullable<decimal> Original_SPOR_PROCENT, global::System.Nullable<decimal> Original_PREMII_BRUTE, global::System.Nullable<decimal> Original_TOTAL_BRUT, global::System.Nullable<decimal> Original_BRUT_IMPOZABIL, global::System.Nullable<decimal> Original_CAS, global::System.Nullable<decimal> Original_CASS, global::System.Nullable<decimal> Original_IMPOZIT, global::System.Nullable<decimal> Original_RETINERI, global::System.Nullable<decimal> Original_VIRAT_CARD) {
            ...
            if ((Original_SPOR_PROCENT.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[9].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[10].Value = ((decimal)(Original_SPOR_PROCENT.Value));
            }
            else {
            ...
            if ((Original_IMPOZIT.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[22].Value = ((decimal)(Original_IMPOZIT.Value));
            }
            else {
        ...
        public virtual int Insert(decimal NR_CRT, string NUME, string PRENUME, string FUNCTIE, global::System.Nullable<decimal> SALAR_BAZA, global::System.Nullable<decimal> SPOR_PROCENT, global::System.Nullable<decimal> PREMII_BRUTE, global::System.Nullable<decimal> TOTAL_BRUT, global::System.Nullable<decimal> BRUT_IMPOZABIL, global::System.Nullable<decimal> CAS, global::System.Nullable<decimal> CASS, global::System.Nullable<decimal> IMPOZIT, global::System.Nullable<decimal> RETINERI, global::System.Nullable<decimal> VIRAT_CARD) {
            ...
            if ((SPOR_PROCENT.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((decimal)(SPOR_PROCENT.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<decimal> SPOR_PROCENT, 
                    ...
                    global::System.Nullable<decimal> Original_SPOR_PROCENT, 
            ...
            if ((SPOR_PROCENT.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((decimal)(SPOR_PROCENT.Value));
            }
            else {
            ...
            if ((Original_SPOR_PROCENT.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((decimal)(Original_SPOR_PROCENT.Value));
            }
            else {
            ...
            if ((Original_CAS.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[32].Value = ((decimal)(Original_CAS.Value));
            }
            else {
            ...
            if ((Original_CASS.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[34].Value = ((decimal)(Original_CASS.Value));
            }
            else {
            ...
            if ((Original_IMPOZIT.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[36].Value = ((decimal)(Original_IMPOZIT.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<decimal> Original_RETINERI, 
                    global::System.Nullable<decimal> Original_VIRAT_CARD) {
            return this.Update(Original_NR_CRT, NUME, PRENUME, FUNCTIE, SALAR_BAZA, SPOR_PROCENT, PREMII_BRUTE, TOTAL_BRUT, BRUT_IMPOZABIL, CAS, CASS, IMPOZIT, RETINERI, VIRAT_CARD, Original_NR_CRT, Original_NUME, Original_PRENUME, Original_FUNCTIE, Original_SALAR_BAZA, Original_SPOR_PROCENT, Original_PREMII_BRUTE, Original_TOTAL_BRUT, Original_BRUT_IMPOZABIL, Original_CAS, Original_CASS, Original_IMPOZIT, Original_RETINERI, Original_VIRAT_CARD);
        }
    }
