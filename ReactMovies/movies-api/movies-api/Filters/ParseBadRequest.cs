    ...
    public class ParseBadRequest : IActionFilter
    {
        ...
        public void OnActionExecuted(ActionExecutedContext context)
        {
            ...
            if (statusCode == 400)
            {
                ...
                {
                    response.Add(badRequestsObjectResult.Value.ToString());
                }
                else if(badRequestsObjectResult.Value is IEnumerable<IdentityError> errors)
                {
                ...
                else  //     pt un obiect cu mai multe
                {
